...
# =========================================================
# 6. RUN BASELINE AND TWITTER
# =========================================================
baseline_results = run_ensemble(BASELINE_TRAIN, BASELINE_TEST, "baseline")
...
comparison = pd.DataFrame([
    {"model_version": "baseline", **baseline_results["ensemble_metrics"]},
    {"model_version": "twitter", **twitter_results["ensemble_metrics"]},
])
...
comparison_csv = OUT_DIR / "ensemble_comparison.csv"
...
full_results_json = OUT_DIR / "full_results.json"
with open(full_results_json, "w") as f:
    json.dump(full_results, f, indent=2)

print(f"\nSaved comparison table to: {comparison_csv}")
print(f"Saved full results to: {full_results_json}")
print("\nDone.")
